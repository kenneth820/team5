...
<td>유저 이름:</td>
<td>
<p class="name">${vVo.name}</p>
</td>
</tr>
<tr>
<td colspan="2">
<p class="selfcomment">${vVo.selfcomment}</p>
</td>
</tr>
</table>
...
style="padding-left: 6px;">${vVo.userid}</td>
<td width="80%" style="padding-left: 10px;"><textarea
rows="5" cols="34" name="content" class=""></textarea></td>
<td style="padding-top: 35px;">
<input type="hidden" value="등록" style="width: 40px; letter-spacing: 5px; float: right;">
</td>
</tr>
</table>
<br>
...
<td width="80%" style="padding-left: 10px;"><input type="text" name="commentin">${comment.reply} </input></td>
</tr>
</c:forEach>
</table>
</form>
